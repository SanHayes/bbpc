<template>
  <div class="hide_div">
    <el-tabs type="border-card">
      <el-tab-pane :label="$t('account.chain')">
      ...
      <el-tab-pane v-if="+onlinereq" :label="$t('account.visa')">
        <RechargeVisa></RechargeVisa>
      </el-tab-pane>
    </el-tabs>
...
<script>
import RechargeVisa from './RechargeVisa.vue'
