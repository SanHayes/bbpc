export default {
    ...
    'enterWehat': 'WeChat',
    'fwmeiti': 'Media',
    'pass1': 'Please enter the withdrawal password',
    'pass2': 'Verify withdrawal password',
    'pass3': 'Set withdrawal password',
    'pass4': 'Please enter the withdrawal password',
    'pass5': 'please enter account',
    'pass6': 'Reset withdrawal password',
    'scan': 'scan',
    ...
    'footer': {
        ...
        'email_info': 'Email：huobi@Exmocoim.vip',
        'address': 'Singapore© 2013-2020 {name}\t',
        'community': 'Community',
        'wechat': 'Wechat',
        'weibo': 'WeiBo',
        ...
        'service': 'Service',
        'apply_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=196',
        'feedback_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=201',
        'about2_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=207',
        'coin_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=212',
        'yinsi_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=217',
        'feilv_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=222',
        'legal_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=227'
    },
    'home': {
        'hourday': '24H Vol',
        'with': 'with',
        ...
        'img2': '2_en.png',
        'img3': '3_en.png',
        'd1': '{name} Global station, nearly 24 hours trading volume<b>{number}</b>USD',
    ...
    'login': {
        ...
        "connect": "Forgot password, please contact customer service!"
    },
    'register': {
        'optional': 'Optional',
        'phone': 'Phone',
        ...
        'codenum': 'please enter verification code',
    ...
    'auth2': {
        ...
        'tip2': 'Please provide a photo of you with the card in your hand. In the same photo, should also include "{name}", date and your signature. Please make sure that your face is visible and that all document details are readable',
        'face': 'The face is clearly visible without occlusion',
        'clearly': 'The photos are clearly visible',
        'notes': 'photo with [{name}] text',
        ...
        'tip4': ' Please provide a screenshot or photo of the assets of your {name} account, including your account name, uid, position details and current time. All the information is clearly readable.',
    ...
    'tpc': {
        ...
        'nodata': 'No data',
        'search': 'Search',
        'tips': '*The content displayed on the current page is filled out by the project party, and {name} is not responsible for the authenticity of the content',
        'time': 'Issue time',
    ...
    'miscro': {
        "amount": 'Entry amount',
        tips: 'Insufficient funds in the account to participate in this event',
        'quotation': 'Markets',
        'transaction': 'Options Trading',
        'symbol': 'Pair',
        'balance': 'Options account',
        'miscroAccount': 'Options account',
        'trade': 'Transaction',
        ...
        'secondValuation': 'Options Account Asset Valuation',
    ...
    'lock': {
        lockming: 'Futures Market',
        pledge: 'Pledge',
        return: 'Earn multiple returns',
        earn: '{currency}Lock position to earn coins',
        quantityPlaceholder: 'Deposit quantity {quantity}',
        income: 'Estimated Total Income',
        reference: 'Reference annualization for the past 3',
        daily: 'Daily interest',
        day: 'day',
        period: 'Lock-up period',
        buy: 'BUY',
        record: 'Locked position record',
