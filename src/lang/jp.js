export default {
    ...
    'enterWehat': '微信',
    'fwmeiti': 'メディア',
    'pass1': 'キャッシュパスワードを入力してください。',
    'pass2': 'キャッシュパスワードを検証する',
    'pass3': 'キャッシュパスワードを設定',
    'pass4': 'キャッシュパスワードを入力してください。',
    'pass5': 'アカウントを入力してください',
    'pass6': 'キャッシュパスワードをリセット',
    'scan': 'さっと掃く',
    'exchangeRate': '為替レート',
    'none': '',
    'code': '検証コードを送信する',
    ...
    'transferOk': '振り替え完了',
    'login_codes1': 'スライダーをドラッグして確認します',
    'login_codes2': '確認済み',
    'login_codes3': 'スライダーをドラッグして確認してください',
    'xieyi': 'ユーザー規約',
    're_xieyi': '当サイトは、デジタル資産取引及び関連サービス（以下、「本サービス」または「サービス」という）を提供するための専用のプラットフォームです。本契約の簡単な表現のために、当サイトは本協定で「私たち」または他の一人称呼称を併用して使用します。このサイトに登録されている自然人または他の主体はすべて当サイトのユーザーである限り、本協議の表現は便利であり、以下に「あなた」または他の第二人称を使用する。本協定の表現の便利さのために、私達はあなたと本協議の中で「両方」と呼びます。私達またはあなたは単に「一方」と呼びます。ここでは特に注意しています。•1デジタル資産自体は金融機関や会社やウェブサイトでは発行されません。2デジタル資産市場は全く新しい、未確認のもので、しかも成長しない可能性があります。3デジタル資産は主に投資者によって大量に使用され、小売と商業市場での使用は比較的少ないです。デジタル資産取引は極めてリスクが高く、一日中絶えず取引が行われています。4  会社が一方的に判断して、あなたが本契約に違反したと判断した場合、またはあなたの管轄区域の法律に基づいて当サイトが提供するサービスまたはあなたが当サイトで提供するサービスを利用する行為は不法であり、会社はいつでもあなたの口座を停止または終了する権利があります。「米国、カナダ、中国香港、日本、キューバ、イラン、北朝鮮、スーダン、シリア、ベネズエラ、クリミア地区」に位置するいかなる人も、当サイトが提供するサービスを利用することを禁止します。また、「中国、イスラエル、イラク、バングラデシュ、ボリビア、エクアドル、キルギス、セヴァストポリ、イギリス（小売ユーザー）」の誰でも本サイトが提供する契約取引サービスを利用することができません。上記の国家リストは異なる国の政策と製品の種類によって変化します。その時は特にお知らせすることはないかもしれません。本協定の更新にご注意ください。デジタル資産の取引は非常にリスクが高く、ほとんどの人には適していません。この取引は部分的な損失または全部の損失を招く可能性があることをご承知の上、お客様は耐えられる損失の程度で取引の金額を決定するべきです。デジタル資産の理解と理解はデリバティブリスクを生むので、何か質問があれば、まず専門顧問の協力を求めることを提案します。また、上記に述べたリスク以外に、予測できないリスクがあります。あなたは慎重に考慮し、明確な判断能力で自分の財政状況及び上記各リスクを評価し、いかなる売買デジタル資産の決定を行い、それによって生じたすべての損失を負担するべきであり、私達はこれに対していかなる責任も負いません。すみません、当サイトはあなたがデジタル資産情報を取得し、取引先を探し、デジタル資産の取引について協議し、取引を展開する場所としてだけを知っています。当サイトはお客様のいかなる取引にも参加していませんので、関連デジタル資産及び/または情報の真実性、合法性と有効性を慎重に判断してください。そして、自分で責任と損失を負担します。2このウェブサイトのいかなる意見、ニュース、検討、分析、価格、提案とその他の情報はすべて普通の市場の評論で、投資の提案を構成しません。私たちはこの情報に依存して直接または間接的に発生した損失は一切負担しません。3このウェブサイトはいつでも自分で決定、修正または変更する権利を保留しています。このウェブサイトはウェブページの「最近更新時間」を更新することによって修正条項と修正ページの表示内容を通知します。私たちは合理的な措置を取ってウェブサイトを確保しました。',
    'xieyi1': {
    ...
    'footer': {
        ...
        'wechat': 'WeChat',
        'weibo': '微博',
        'email_info': 'メールボックス：huobi@Exmocoim.vip',
        'email_pre': 'カスタマーサービス：',
        'address': 'シンガポール© 2013-2020 {name}',
        'email': 'ビジネスメールアドレス',
        'feedback': '問題フィードバック',
        'about2': '会社の概要',
        'coin': 'デジタル資産の紹介',
        'service': 'サービス',
        'apply_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=197',
        'feedback_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=202',
        'about2_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=208',
        'coin_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=213',
        'yinsi_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=218',
        'feilv_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=223',
        'legal_url': 'https://Scoin.vip/dist/#/components/noticeDetail?id=228'
    },
    'home': {
        'with': 'はい、',
        'myMarkets': '交易所',
        ...
        'atrade': '{name}グローバルステーションのアカウントを登録して、取引の旅を開始します。',
        'Gcoin': '{name}',
        ...
        'img2': '2_jp.png',
        'img3': '3_jp.png',
        'd1': '{name} Global，24時間の出来高<b>{number}</b>ドル',
    ...
    'login': {
        ...
        'autologin': '自動ログイン',
        "connect": "パスワードを忘れた場合は、カスタマーサービスにお問い合わせください。"
    },
    'register': {
        optional: 'オプション',
        'phone': '携帯番号の登録',
    ...
    'auth2': {
        ...
        'tip2': '証明書を持って撮った写真を提供してください。同じ写真にも「{name}」と日付とサインのコメントが含まれています。顔がよく見えるようにしてください。証明書の詳細は全部分かります',
        'face': '顔がくっきりと見える',
        'clearly': '写真が鮮明に見える',
        'notes': '[{name}]の文字コメントが付いています',
        ...
        'tip4': ' ご本人の{name}アカウントの資産明細のスクリーンショットまたは写真を提供してください。画像にはお客様の口座名、uid、在庫保持の詳細、現在の時間が含まれています。すべての情報をクリアして読むことができます。',
    ...
    'tpc': {
        ...
        'nodata': 'データがありません',
        'search': '索',
        'tips': '*現在のページの展示内容はプロジェクト側自身で記入して、{name}はこの内容の真実性に責任を負わない',
        'time': '発行時間',
        'total': '総発行量',
        'circulation': 'トークンフロー',
        'price': '発行価格',
    ...
    'miscro': {
        amount: '入金金額',
        tips: 'このイベントに参加するにはアカウントの資金が不足しています',
        'quotation': '相場',
        'transaction': 'オプション取引',
        'symbol': '取引ペア',
        'balance': '残額',
    ...
    'lock': {
        ...
        pledge: '質権設定',
        return: '多重利回りを上げる',
        earn: '{currency}倉庫をロックして貨幣を稼ぐ',
        quantityPlaceholder: '貨幣の数 {quantity}',
        income: '総利益を見込む',
        reference: 'ここ3日は年化を参考にします',
        daily: '日本円の利息',
        day: '空',
        period: 'ロック期限',
        buy: '購入',
