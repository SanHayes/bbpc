            ...
            <div class="flex" style="max-width: 1200px; margin: 0 auto;">
                <div class="reg-content" style="min-height: 700px; width:620px;">
                    ...
                    <div class="step-one" v-show="true">
                        ...
                        <div class="tip" v-if="false" style="margin-bottom:10px">
                            <span class="required">*</span>
                            {{ $t("register.codenum") }}
                        </div>
                    ...
                    <div class="invite-box">
                        <div class="tip">
                            <span class="required" v-if='invitation_code === "1"'>*</span>
                            {{ $t("register.invitecode") }}
                        </div>
                        <input type="text" v-model="invite" class="invite-input" :placeholder="inpInvite" />
                    </div>
                    <div id="codess">
...
export default {
    ...
    computed:{
        ...mapGetters(['invitation_code']),
        inpInvite(){
            let text = this.$t('register.invitecode')
            if (this.invitation_code === '0') {
                text += ` (${this.$t('register.optional')})`
            }
            return text
        },
    },
           ...
           /* else if (this.code == "" && this.isMb) {
              ...
              /*  if (this.isMb) {
                ...
                if (that.pwd == "") {
                    ...
                    return;
                } else if (that.invite == '' && this.invitation_code === '1') {
