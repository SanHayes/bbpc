  ...
  <div class="login">
    ...
    <div class="contentBK" style="height: calc(100% - 20px)">
      <div class="content-wrap" style="height: 100%">
        <div class="account">
          <div class="main">
            {{ $store.state.web.name }}
            <p class="main_title">{{ $t('login.welcome',{name: $store.state.web.name}) }}</p>
            ...
            <div style="margin-top: 10px;">
              ...
              <div class="have-account" @click="$message.info($t('login.connect'))">
                <div class="baseColor" style="cursor:pointer">
                  {{ $t('login.forget') }}
                </div>
              </div>
            </div>
